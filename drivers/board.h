...
#define RT_DO2_Pin   GET_PIN(E, 8)
#define RT_DO3_Pin   GET_PIN(E, 7)
#define RT_DI0_Pin   GET_PIN(B, 8)
#define RT_DI1_Pin   GET_PIN(B, 9)
#define RT_DI2_Pin   GET_PIN(E, 0)
#define RT_DI3_Pin   GET_PIN(E, 1)

#define RT_LED0_Pin   GET_PIN(B, 15)
#define RT_LED1_Pin   GET_PIN(D, 8)
#define RT_LED2_Pin   GET_PIN(D, 9)

#define RT_SPI1_CS_PIN    GET_PIN(A, 4)
#define SPI1_CS_PORT      GPIOA
#define SPI1_CS_PIN       GPIO_PIN_4
#define RT_SPI1_SCK_PIN   GET_PIN(A, 5)
#define RT_SPI1_MISO_PIN  GET_PIN(A, 6)
#define RT_SPI1_MOSI_PIN  GET_PIN(B, 5)

#define RT_SPI3_CS0_PIN   GET_PIN(D, 0)
#define SPI3_CS0_Port     GPIOD
#define SPI3_CS0_Pin      GPIO_PIN_0
#define RT_SPI3_CS1_PIN   GET_PIN(D, 1)
#define SPI3_CS1_Port     GPIOD
#define SPI3_CS1_Pin      GPIO_PIN_1
#define RT_SPI3_CS2_PIN   GET_PIN(D, 2)
#define SPI3_CS2_Port     GPIOD
#define SPI3_CS2_Pin      GPIO_PIN_2

// ETH
#define RT_ETH_INT_Pin    GET_PIN(E, 14)
#define RT_ETH_RST_Pin    GET_PIN(E, 15)
...
#define RT_PWM0_EN        GET_PIN(D, 14)
#define PWM0_EN_PORT      GPIOD
#define PWM0_EN_Pin       GPIO_PIN_14
#define RT_PWM0_DIR       GET_PIN(D, 15)
#define PWM0_DIR_PORT     GPIOD
#define PWM0_DIR_Pin      GPIO_PIN_15

#define RT_PWM1_EN        GET_PIN(C, 8)
#define PWM1_EN_PORT      GPIOC
#define PWM1_EN_Pin       GPIO_PIN_8
#define RT_PWM1_DIR       GET_PIN(A, 11)
#define PWM1_DIR_PORT     GPIOA
#define PWM1_DIR_Pin      GPIO_PIN_11

// ECODER
// unused
#define E0_Port           GPIOD
#define RT_EA0_Pin        GET_PIN(D, 12)
#define EA0_Pin           GPIO_PIN_12
#define RT_EB0_Pin        GET_PIN(D, 13)
#define EB0_Pin           GPIO_PIN_13

#define E1_Port           GPIOE
#define RT_EA1_Pin        GET_PIN(E, 9)
