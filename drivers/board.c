...
{
    //return;
    rt_pin_mode(RT_ETH_RST_Pin, PIN_MODE_OUTPUT);
    rt_pin_write(RT_ETH_RST_Pin, PIN_HIGH);
    rt_thread_mdelay(50);
    rt_pin_write(RT_ETH_RST_Pin, PIN_LOW);
    rt_thread_mdelay(50);
    rt_pin_write(RT_ETH_RST_Pin, PIN_HIGH);
}
...
void HAL_TIM_Encoder_MspInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM1_MspInit 0 */
    ...
    */
    ...
    HAL_GPIO_Init(E1_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM4_MspInit 0 */
    ...
    PD13     ------> TIM4_CH2
    */
    GPIO_InitStruct.Pin = EA0_Pin|EB0_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM4;
    HAL_GPIO_Init(E0_Port, &GPIO_InitStruct);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PE11     ------> TIM1_CH2
    */
    HAL_GPIO_DeInit(E1_Port, EA1_Pin|EB1_Pin);
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PD13     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(E1_Port, EA0_Pin|EB0_Pin);
...
INIT_DEVICE_EXPORT(MX_TIM8_Init);
